...
export const metadata: Metadata = {
  ...
  title: {
    default: "Lucky Club Gift Articles | Personalized Gifts in India",
    template: "%s | Lucky Club Gift Articles",
  },
  ...
  keywords: [
    ...
    "customized gifts",
    "gift articles",
    "Lucky Club Gift Articles",
  ],
  applicationName: "Lucky Club Gift Articles",
  authors: [{ name: "Lucky Club Gift Articles" }],
  ...
  openGraph: {
    ...
    locale: "en_IN",
    url: SITE_URL,
    siteName: "Lucky Club Gift Articles",
    title: "Lucky Club Gift Articles | Personalized Gifts in India",
    description: "Thoughtful personalized gifts made for the people and moments that matter most.",
    images: [{ url: "/lcc.jpg.jpeg", width: 1200, height: 630, alt: "Lucky Club Gift Articles" }],
  },
  twitter: {
